...
public class SocketFactory extends SSLSocketFactory {
	...
	public SocketFactory() throws CertificateException, KeyStoreException, NoSuchAlgorithmException, IOException,
	...
	public SocketFactory(SocketFactoryOptions options) throws KeyStoreException, NoSuchAlgorithmException, IOException,
			KeyManagementException, java.security.cert.CertificateException, UnrecoverableKeyException {
...
//				Timber.v("Alias: %s isKeyEntry:%s isCertificateEntry:%s", o, caKeyStore.isKeyEntry(o),
